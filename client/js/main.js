...
const DECOR = {
  ...
  jungle_tree_great: 'A tree vast beyond reckoning. Something hollowed a den in its bole.',
  jungle_tree_stump: 'The stump of a fallen giant — a family could live inside.',
  jungle_tree_barrel: 'A barrel-thick trunk, roots gripping the earth like fingers.',
  jungle_log_arch: 'A fallen giant arched over the trail, furred with moss.',
  jungle_log: 'A rotting log, soft with moss and beetles.',
  jungle_fern: 'A fern taller than a man.',
  jungle_monstera: 'Broad split leaves dripping with last night\'s rain.',
  jungle_palm: 'A slender wild palm reaching for the canopy gap.',
  jungle_leaves: 'A thicket of enormous leaves. Anything could hide in there.',
  ruin_totem: 'A carved totem column of some forgotten people.',
  ruin_statue: 'A moss-eaten idol. Its eyes seem to follow you.',
  ruin_rubble: 'Tumbled temple stones, half-swallowed by the jungle.',
  ruin_gate: 'A sealed temple gate flanked by idols. The dark within breathes cold air — one day, a way down.',
